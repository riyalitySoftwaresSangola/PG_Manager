...
<div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
    <div class="flex-grow-1">
        <h4 class="fs-18 fw-semibold mb-0">Tenant Records</h4>
    </div>
    <div class="text-end">
                ...
                <div class="row align-items-center g-3">
                    ...
                    <div class="col-md-3">
                        <div class="position-relative">
                            <input type="text" id="searchInput" class="form-control ps-4" placeholder="Search Tenant...">
                    ...
                    <!-- Status Filter -->
                    <div class="col-md-3">
                        <form action="${pageContext.request.contextPath}/filterTenants" method="get" id="statusForm">
...
<div class="table-responsive mt-3">
    <table class="table table-nowrap mb-0" id="tenantTable">
            ...
            <tr>
                ...
                <td class="pe-3">
                    <div class="hstack gap-1 justify-content-end">
                        ...
                        <a href="${pageContext.request.contextPath}/DeleteTenant?id=${tenant.tenantId}"
