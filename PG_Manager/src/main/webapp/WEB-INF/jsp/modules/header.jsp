        ...
        <div class="sidenav-menu">
            ...
            <div data-simplebar>
                ...
                <li class="side-nav-item">
                    <a href="customerRegistration" class="side-nav-link">
                ...
                <li class="side-nav-item">
                    <a href="roomManagementForm" class="side-nav-link">
                ...
                <li class="side-nav-item">
                    <a href="bedAssiged" class="side-nav-link">
                        <span class="menu-icon"><i class="ti ti-users"></i></span>
                        <span class="menu-text">Assiogned Bed  </span>
                    </a>
                </li>
                
                 <li class="side-nav-item">
                    <a href="mealEntry" class="side-nav-link">
                        <span class="menu-icon"><i class="ti ti-file-text"></i></span>
                        <span class="menu-text"> Meal Entry  </span>
                    </a>
                </li>
                

                <li class="side-nav-item">
                    <a href="billingForm" class="side-nav-link">
                        <span class="menu-icon"><i class="ti ti-file-text"></i></span>
                 ...
                 <li class="side-nav-item">
                    <a href="paymentEntry" class="side-nav-link">
                        <span class="menu-icon"><i class="ti ti-file-text"></i></span>
                        <span class="menu-text"> Payment Entry  </span>
                    </a>
                </li>
                
                  <li class="side-nav-item">
                    <a href="complaints" class="side-nav-link">
                        <span class="menu-icon"><i class="ti ti-file-text"></i></span>
                   ...
                   <li class="side-nav-item">
                    <a href=leave class="side-nav-link">
                        <span class="menu-icon"><i class="ti ti-file-text"></i></span>
                    ...
                    <div class="topbar-item">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <img src="resources/assets/images/flags/it.svg" alt="user-image" class="me-1 rounded" height="18"> <span class="align-middle">Italian</span>
                                </a>
