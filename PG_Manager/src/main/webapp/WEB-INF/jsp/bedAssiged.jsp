...
<div class="row">
    <div class="col-lg-12 p-5">
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted">Assign a bed to a customer by selecting room, bed, and customer details.</p>
                ...
                <form class="needs-validation" action="assignBed" method="post" novalidate>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="roomId" name="roomId" required>
                            ...
                            <%-- Replace this with your list of rooms from controller --%>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="bedNumber" name="bedNumber" required>
                    ...
                    <!-- Assign to Customer -->
                    <div class="mb-3">
                        <label class="form-label" for="customerId">Assign to Customer</label>
