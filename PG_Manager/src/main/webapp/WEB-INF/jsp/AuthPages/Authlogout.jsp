...
<head>
    <meta charset="utf-8" />
    <title>Log Out | Osen - Responsive Bootstrap 5 Admin Dashboard</title>
        ...
        <div class="row g-0 justify-content-center w-100 m-xxl-5 px-xxl-4 m-3">
            <div class="col-xl-4 col-lg-5 col-md-6">
                <div class="card overflow-hidden text-center h-100 p-xxl-4 p-3 mb-0">
                    ...
                    <p class="text-danger fs-14 my-3">Back to <a href="auth-login.html" class="text-dark fw-semibold ms-1">Login !</a>
