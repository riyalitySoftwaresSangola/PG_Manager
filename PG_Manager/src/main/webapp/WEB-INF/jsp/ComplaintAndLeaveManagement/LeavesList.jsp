	...
	<div class="text-end">
		<ol class="breadcrumb m-0 py-0">
			<li class="breadcrumb-item"><a href="javascript: void(0);">Admin
					Panel</a></li>
			<li class="breadcrumb-item"><a href="javascript: void(0);">Leave
					Management</a></li>
				...
				<div class="row justify-content-between g-3">
					<div class="col-lg-6">
						<div class="row g-3">
							...
							<!-- Status Filter -->
							<div class="col-lg-4">
								<form action="${pageContext.request.contextPath}/filterLeaves"
										...
										<div class="flex-grow-1">
											<select class="form-select my-1 my-md-0" name="status"
												...
												<option value="REJECTED"
													${param.status == 'REJECTED' ? 'selected' : ''}>Rejected</option>
											</select>
										</div>
									</div>
								</form>
							...
							<div class="col-lg-4">
								<div class="input-group">
									<input type="text" class="form-control"
										data-provider="flatpickr" data-deafult-date="01 Sep to 30 Sep"
							...
							<tr>
								...
								<%--  <td class="pe-3">
                                        <div class="hstack gap-1 justify-content-end">
                                            <a href="approveLeave/${leave.id}" 
                                               class="btn btn-soft-success btn-icon btn-sm rounded-circle">
                                                <i class="ti ti-check"></i>
                                            </a>
                                            <a href="rejectLeave/${leave.id}" 
								...
								<td>
									<form action="approveLeave/${leave.id}" method="get"
										style="display: inline;">
										<button type="submit" class="btn btn-success btn-sm">Approve</button>
									</form>
									<form action="rejectLeave/${leave.id}" method="get"
										style="display: inline;">
